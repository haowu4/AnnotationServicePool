...
public class AnnotationServicePool implements AnnotatorService {
    ...
    public TextAnnotation createBasicTextAnnotation(String s, String s1, String s2) throws AnnotatorException {
        AnnotatorService as;
        try {
    ...
    public TextAnnotation createBasicTextAnnotation(String s, String s1, String s2, Tokenizer.Tokenization tokenization) throws AnnotatorException {
        AnnotatorService as;
        try {
            as = available.poll(60, TimeUnit.SECONDS);
        } catch (InterruptedException e) {
    ...
    public TextAnnotation createAnnotatedTextAnnotation(String s, String s1, String s2) throws AnnotatorException {
        AnnotatorService as;
        try {
            as = available.poll(60, TimeUnit.SECONDS);
        } catch (InterruptedException e) {
    ...
    public TextAnnotation createAnnotatedTextAnnotation(String s, String s1, String s2, Tokenizer.Tokenization tokenization) throws AnnotatorException {
        AnnotatorService as;
        try {
            as = available.poll(60, TimeUnit.SECONDS);
        } catch (InterruptedException e) {
    ...
    public TextAnnotation createAnnotatedTextAnnotation(String s, String s1, String s2, Set<String> set) throws AnnotatorException {
        AnnotatorService as;
        try {
            as = available.poll(60, TimeUnit.SECONDS);
        } catch (InterruptedException e) {
    ...
    public TextAnnotation createAnnotatedTextAnnotation(String s, String s1, String s2, Tokenizer.Tokenization tokenization, Set<String> set) throws AnnotatorException {
        AnnotatorService as;
        try {
            as = available.poll(60, TimeUnit.SECONDS);
        } catch (InterruptedException e) {
    ...
    public TextAnnotation annotateTextAnnotation(TextAnnotation textAnnotation, boolean b) throws AnnotatorException {
        AnnotatorService as;
        try {
            as = available.poll(60, TimeUnit.SECONDS);
        } catch (InterruptedException e) {
